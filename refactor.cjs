...
lines.splice(12, 0, ...importLines);

// 2. Find the return block start
const returnStartIndex = lines.findIndex(line => line.includes('return (') && line.trim() === 'return (');
...
// 3. Truncate everything after the return
const keepLines = lines.slice(0, returnStartIndex);
